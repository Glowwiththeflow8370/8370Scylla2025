...
public class SparkFlexIntake implements IntakeBase {
    ...
    public SparkFlexIntake(){
        ...
        IntakeMotorFollower = new SparkFlex(IntakeConstants.IntakeMotorFollowerID, MotorType.kBrushless);
        ...
        IntakeMotorFollowerConfig.follow(IntakeMotor);

        // Apply configuration
        IntakeMotor.configure(IntakeMotorConfig, 
        ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);

        IntakeMotorFollower.configure(IntakeMotorFollowerConfig, 
        ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    }
