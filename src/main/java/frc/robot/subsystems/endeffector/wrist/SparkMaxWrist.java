...
public class SparkMaxWrist extends SubsystemBase {
  private final com.revrobotics.spark.SparkMax wristMotor;
  private final com.revrobotics.spark.SparkClosedLoopController pidController;
  ...
  public SparkMaxWrist() {
    ...
    wristMotor =
        new com.revrobotics.spark.SparkMax(WristConstants.WristMotorID, MotorType.kBrushless);
